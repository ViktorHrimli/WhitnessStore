  ...
  useEffect(() => {
    if ("serviceWorker" in navigator) {
      navigator.serviceWorker
        .register("/service_worker_register.js")
    ...
    <section className={styles.section}>
      ...
      {isSocial && (
        <div className={styles.social_cantainer}>
          ...
          <Link
            target="_blank"
            href="https://api.whatsapp.com/send/?phone=491764201647&text=Hallo.mich+interessiert&type=phone_number&app_absent=0"
          >
            <div>
              <svg
                width="50"
