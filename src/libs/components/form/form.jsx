    ...
    <>
      ...
      <div className={stules.flex} >
        <div className={stules.border}></div>
          ...
          <label
            onClick={post}
            for="post" className={stules.text_radio}>
            Zur Post
          </label>
      </div>
      ...
      <label className={stules.title}>
        Versandadresse
          <textarea
            className={stules.input}
            style={{ height: "136px", padding: "17px 20px 5px 17px", resize: "none" }}
            type="text"
      ...
      <div className={stules.flex} style={{ marginBottom: "30px" }}>
        ...
        <p className={stules.text}>Zwischensumme:
          <span> {totalPrice.toFixed(2)}</span> €</p>
        
        <p className={stules.text}>Zur Post:
          <span> {isDelivery.toFixed(2)}</span> €</p>
        
        <p className={stules.title_price}
          style={{ marginBottom: "30px" }}>Gesamtsumme: 
          <span> {totalPrice.toFixed(2)}</span> €</p>
